...
# Create Avon Points views in ecommerce app
cat > ecommerce/avon_views.py << 'EOF'
...
# Update ecommerce URLs to include Avon Points routes
cat >> ecommerce/urls.py << 'EOF'
...
echo "Avon Points views created successfully"
